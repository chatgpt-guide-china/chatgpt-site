# ChatGPT 中文版：国内免费入口（支持GPT-4、4o画图，无需翻墙）【6月更新】
...
[**ChatGPT 中文版**](https://talk.lanjing.pro) 是 OpenAI 开发的 ChatGPT 模型的中文使用版本，专为中文用户提供更流畅、更精准的 AI 对话体验。   
...
| **[talk.lanjing.pro](https://talk.lanjing.pro)**   | GPT-4.1, GPT-3.5, o1, o3, DeepSeek-R1, Claude 3.7 sonnet  | ⭐⭐⭐⭐⭐  | 使用简单，先进大模型，4o画图，适合新手用户                       |
